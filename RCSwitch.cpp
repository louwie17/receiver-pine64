 ...
 */
void RCSwitch::enableReceive(int interrupt, int gpio) {
  this->nReceiverInterrupt = interrupt;
  this->enableReceive(gpio);
}

void RCSwitch::enableReceive(int gpio) {
  if (this->nReceiverInterrupt != -1) {
    RCSwitch::nReceivedValue = 0;
    RCSwitch::nReceivedBitlength = 0;
    wiringPiISR(gpio, INT_EDGE_BOTH, &handleInterrupt);
  }
}
